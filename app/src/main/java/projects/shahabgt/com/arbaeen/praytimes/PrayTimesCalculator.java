package com.example.jonathan.arbaeen.praytimes;
...
import static com.example.jonathan.arbaeen.praytimes.StaticUtils.deg;
import static com.example.jonathan.arbaeen.praytimes.StaticUtils.dtr;
import static com.example.jonathan.arbaeen.praytimes.StaticUtils.fixHour;
import static com.example.jonathan.arbaeen.praytimes.StaticUtils.min;
import static com.example.jonathan.arbaeen.praytimes.StaticUtils.rtd;
...
public class PrayTimesCalculator {
    ...
    public PrayTimesCalculator() {
        this(CalculationMethod.Tehran); // default method
    }
